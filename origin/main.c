...
#define PAGE "search?fr=auc_top&p=LEGO+パーツ&oq=lego+pa&auccat=0&tab_ex=commerce&sc_i=auc_sug&ei=UTF-8&b=21" 
#define PORT 80
...
int main(int argc, char **argv)
{
    ...
    char *ip;
    char *get;
    //char buf[BUFSIZ+1];BUFFERSIZE  /*8192 seemed to be not enough*/
    char buf[BUFFERSIZE+1];
    char *host;
    char *page;
    
    //fprintf(stdout,"Which page do you want to search?[1+20*k,k>=0]\n");
    //char pagenum[20];
    //fgets(pagenum,sizeof(pagenum),stdin);
